...
load_dotenv()
TELEGRAM_TOKEN = os.getenv("TELEGRAM_TOKEN")  # Set in .env as TELEGRAM_TOKEN=your-token
XAI_API_KEY = os.getenv("XAI_API_KEY")  # Optional, can be dummy value
XAI_API_URL = "https://api.xai.com/grok"  # Hypothetical xAI API
